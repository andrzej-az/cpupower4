...
# see https://github.com/andrzej-az/cpupower4/issues/102
# the TOOL_SUFFIX enables per-user installations on a multi-user system
# see https://github.com/andrzej-az/cpupower4/issues/84
if [ -z "${TOOL_SUFFIX}" ]
then
    CFC_DIR="${PREFIX}/bin"
...
then
    ...
    # https://github.com/andrzej-az/cpupower4/issues/102
...
then
    if [ "$(id -u)" -ne 0 ]; then
        ...
        echo "Please have a look at https://github.com/andrzej-az/cpupower4/issues/102"
