This is the fork of https://github.com/deinstapel/cpupower with gnome 45+ support
...
<p align="center">
  ...
  <br>
  <a href="https://github.com/andrzej-az/cpupower4/actions?query=workflow%3A%22latest%20build%22">
    <img src="https://github.com/andrzej-az/cpupower4/workflows/latest%20build/badge.svg" alt="latest build">
  </a>
  <a href="https://github.com/andrzej-az/cpupower4/actions?query=workflow%3A%22release%20build%22">
    <img src="https://github.com/andrzej-az/cpupower4/workflows/release%20build/badge.svg" alt="release build">
  </a>
  <a href="https://github.com/andrzej-az/cpupower4/releases">
    <img alt="Lastest release" src="https://img.shields.io/github/v/release/deinstapel/cpupower?label=latest%20release&sort=semver">
  </a>
  <img alt="Gnome 47" src="https://img.shields.io/badge/gnome-47-blue?logo=gnome&logoColor=white">
  <a href="https://github.com/andrzej-az/cpupower4/blob/master/LICENSE">
...
> Info: It is safe to install this extension if only a single package is installed by the below `apt-get install` command. If more packages are to be installed, please stop doing so and if unsure [create an issue](https://github.com/andrzej-az/cpupower4/issues/new/choose) asking for help!
...
```
$ gnome-extensions enable cpupower4@mko-sl.de
```
...
```
$ gnome-shell-extension-tool -e cpupower4@mko-sl.de
```
...
> Info: It is safe to install this extension if only a single package is installed by the below `dnf install` command. If more packages are to be installed, please stop doing so and if unsure [create an issue](https://github.com/andrzej-az/cpupower4/issues/new/choose) asking for help!
...
If your distribution is capable of installing `DEB` or `RPM` packages, have a look at the [releases page](https://github.com/andrzej-az/cpupower4/releases) of this repository for downloadable pre-built packages.

Another option is to install the extension zip file manually. To do so, download the latest `zip` from the [release page](https://github.com/andrzej-az/cpupower4/releases). Now run the following commands:
...
$ cd /tmp
$ git clone https://github.com/andrzej-az/cpupower4.git
$ cd cpupower
...
Clone the respository to `~/.local/share/gnome-shell/extensions/cpupower4@mko-sl.de` and reload the extension by restarting your gnome-shell.
